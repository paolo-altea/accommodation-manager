...
`room_category` INT NOT NULL DEFAULT 0,
`room_code` VARCHAR(255) NOT NULL,
`room_surface` INT NULL DEFAULT NULL,
`room_people` VARCHAR(20) NULL DEFAULT '',
`room_price_from` DECIMAL(10,2) NULL DEFAULT NULL,
...
`room_category_parent` INT NULL DEFAULT 0,
...
`typology_id` INT NOT NULL DEFAULT 0,
