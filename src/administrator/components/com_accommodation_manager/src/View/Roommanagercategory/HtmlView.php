...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		{
			ToolbarHelper::apply('roommanagercategory.apply', 'JTOOLBAR_APPLY');
			ToolbarHelper::save('roommanagercategory.save', 'JTOOLBAR_SAVE');
		}

		if (!$checkedOut && ($canDo->get('core.create')))
		{
			ToolbarHelper::custom('roommanagercategory.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
		}

		// If an existing item, can save to a copy.
		if (!$isNew && $canDo->get('core.create'))
		{
			ToolbarHelper::custom('roommanagercategory.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
		}
		...
		{
			ToolbarHelper::cancel('roommanagercategory.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
			ToolbarHelper::cancel('roommanagercategory.cancel', 'JTOOLBAR_CLOSE');
		}
	}
}
