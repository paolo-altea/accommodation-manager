 ...
 * @since  2.0.1
 */
class ManagerratetypologyModel extends AdminModel
{
	/**
	 ...
	 * @since   2.0.1
	 */
	public function getTable($type = 'Managerratetypology', $prefix = 'Administrator', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
								'com_accommodation_manager.managerratetypology', 
								'managerratetypology',
								array(
									'control' => 'jform',
									'load_data' => $loadData 
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_accommodation_manager.edit.managerratetypology.data', array());
	...
	/**
	 * Method to duplicate an Managerratetypology
	 *
