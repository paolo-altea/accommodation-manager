...
/**
 * Methods supporting a list of Managerratetypologies records.
 *
 * @since  2.0.1
 */
class ManagerratetypologiesModel extends ListModel
{
	/**
	* Constructor.
	*
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'rate_typology_fr', 'a.rate_typology_fr',
				'rate_typology_es', 'a.rate_typology_es',
			);
		}
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__accommodation_manager_rate_typologies` AS a');
