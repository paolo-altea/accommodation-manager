 ...
 * @since  2.0.1
 */
class ManagerratetypologiesController extends AdminController
{
	/**
	 * Method to clone existing Managerratetypologies
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_accommodation_manager&view=managerratetypologies');
	}
	 ...
	 * @since   2.0.1
	 */
	public function getModel($name = 'Managerratetypology', $prefix = 'Administrator', $config = array())
	{
