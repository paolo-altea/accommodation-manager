 ...
 * @since  2.0.1
 */
class ManagerroomcategoriesController extends AdminController
{
	/**
	 * Method to clone existing Managerroomcategories
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_accommodation_manager&view=managerroomcategories');
	}
	 ...
	 * @since   2.0.1
	 */
	public function getModel($name = 'Roommanagercategory', $prefix = 'Administrator', $config = array())
	{
