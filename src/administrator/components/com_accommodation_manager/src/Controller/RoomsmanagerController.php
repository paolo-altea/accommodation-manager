 ...
 * @since  2.0.1
 */
class RoomsmanagerController extends AdminController
{
	/**
	 * Method to clone existing Roomsmanager
	 *
	 * @return  void
	 *
	 * @throws  Exception
	 ...
	 * @since   2.0.1
	 */
	public function getModel($name = 'Roommanager', $prefix = 'Administrator', $config = array())
	{
