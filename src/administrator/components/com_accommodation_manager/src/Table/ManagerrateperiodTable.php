 ...
 * @since 2.0.1
 */
class ManagerrateperiodTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!Factory::getUser()->authorise('core.admin', 'com_accommodation_manager.managerrateperiod.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				...
				"/access/section[@name='managerrateperiod']/"
			);
			$default_actions = Access::getAssetRules('com_accommodation_manager.managerrateperiod.' . $array['id'])->getData();
			$array_jaccess   = array();
