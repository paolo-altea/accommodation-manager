 ...
 * @since 2.0.1
 */
class RoommanagercategoryTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!Factory::getApplication()->getIdentity()->authorise('core.admin', 'com_accommodation_manager.roommanagercategory.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				...
				"/access/section[@name='roommanagercategory']/"
			);
			$default_actions = Access::getAssetRules('com_accommodation_manager.roommanagercategory.' . $array['id'])->getData();
			$array_jaccess   = array();
