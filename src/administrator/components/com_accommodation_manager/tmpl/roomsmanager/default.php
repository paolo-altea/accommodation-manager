...
if ($saveOrder) {
    $saveOrderingUrl = 'index.php?option=com_accommodation_manager&task=roomsmanager.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}
?>

<form action="<?php echo Route::_('index.php?option=com_accommodation_manager&view=roomsmanager'); ?>" method="post"
            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <?php if (!$this->hasCategories) : ?>
                    <div class="alert alert-warning">
                        ...
                        <?php echo Text::_('COM_ACCOMMODATION_MANAGER_NO_CATEGORIES_DESC'); ?>
                        <a href="<?php echo Route::_('index.php?option=com_accommodation_manager&task=roommanagercategory.add'); ?>" class="alert-link">
                ...
                <table class="table table-striped" id="roommanagerList">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="d-none d-md-table-cell">
                            <?php echo HTMLHelper::_('searchtools.sort', Text::sprintf('COM_ACCOMMODATION_MANAGER_TITLE_LANG', strtoupper($lang)), 'a.room_title_' . $lang, $listDirn, $listOrder); ?>
                        </th>
                        <?php endforeach; ?>
                        <th scope="col" class="d-none d-md-table-cell">
                        ...
                        <th scope="col" class="d-none d-lg-table-cell">
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_ACCOMMODATION_MANAGER_ROOMSMANAGER_ROOM_CODE', 'a.room_code', $listDirn, $listOrder); ?>
                        </th>
                    ...
                    ?>
                        <tr class="row<?php echo $i % 2; ?>" data-draggable-group="1" data-transition>
                            ...
                            <td class="text-center">
                                <?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'roomsmanager.', $canChange, 'cb'); ?>
                            </td>

                            <td>
                                <?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
                                    <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'roomsmanager.', $canCheckin); ?>
                                <?php endif; ?>
                                <?php if ($canEdit) : ?>
                                    <a href="<?php echo Route::_('index.php?option=com_accommodation_manager&task=roommanager.edit&id=' . (int) $item->id); ?>">
                            ...
                            <td class="d-none d-lg-table-cell">
                                <?php echo $this->escape($item->room_code); ?>
                            </td>
