...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_accommodation_manager&task=managerratetypologies.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
	HTMLHelper::_('draggablelist.draggable');
}

?>

<form action="<?php echo Route::_('index.php?option=com_accommodation_manager&view=managerratetypologies'); ?>" method="post"
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo LayoutHelper::render('joomla.searchtools.default', array('view' => $this)); ?>
				...
				<table class="table table-striped" id="managerratetypologyList">
					<thead>
					<tr>
						<th width="1%" >
						...
						<tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
							...
							<td>
								<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
									<?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'managerratetypologies.', $canCheckin); ?>
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo Route::_('index.php?option=com_accommodation_manager&task=managerratetypology.edit&id='.(int) $item->id); ?>">
							...
							<td>
								<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'managerratetypologies.', $canChange, 'cb'); ?>
							</td>
							<td>
								<?php echo $item->rate_typology_de; ?>
							</td>
							<td>
								<?php echo $item->rate_typology_it; ?>
							</td>
							<td>
								<?php echo $item->rate_typology_en; ?>
							</td>
							<td>
								<?php echo $item->rate_typology_fr; ?>
							</td>
							<td>
								<?php echo $item->rate_typology_es; ?>
							</td>
