...
namespace Accomodationmanager\Module\AccommodationRates\Site\Dispatcher;
...
class Dispatcher extends AbstractModuleDispatcher implements HelperFactoryAwareInterface
{
	...
	protected function getLayoutData(): array
	{
		...
		$data['rooms']      = $helper->getRooms();
		$data['typologies'] = $helper->getTypologies();
		$data['grid']       = $helper->getRatesGrid();
